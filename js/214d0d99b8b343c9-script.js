...
Core.utils.deferBootstrap(
  {
    ...
    props: JSON.parse(
      '{"appointmentsPageId":"45b86c0a-9b53-4513-8425-a1f054c802fc","websiteId":"8e320b80-659d-4f80-b0ac-2aa5aa91f0c2","rootDomain":"godaddy.com","domainName":"xcelpv48.godaddysites.com","pageRoute":"/stempedia","isReseller":false,"staticContent":{"cartIcon":"Shopping Cart Icon"},"widgetId":"717b079b-c907-4135-a552-f66c429109fa","section":"default","category":"neutral","locale":"en-IN","env":"production","renderMode":"PUBLISH"}'
    ),
    context: JSON.parse(
...
Core.utils.deferBootstrap(
  {
    ...
    props: JSON.parse(
      '{"toggleId":"n-110016-navId-mobile","uniqueId":"n-110016","style":{"color":"highContrast",":hover":{"color":"highlight"},"@md":{"display":"none"}},"widgetId":"717b079b-c907-4135-a552-f66c429109fa","section":"default","category":"neutral","locale":"en-IN","env":"production","renderMode":"PUBLISH"}'
    ),
    context: JSON.parse(
...
Core.utils.deferBootstrap(
  {
    ...
    props: JSON.parse(
      '{"toggleId":"more-110027","label":"More","dataAid":"NAV_MORE","navBarId":"navBarId-110024","widgetId":"717b079b-c907-4135-a552-f66c429109fa","section":"default","category":"neutral","locale":"en-IN","env":"production","renderMode":"PUBLISH"}'
    ),
    context: JSON.parse(
...
window.wsb["CalculateNavSpacing"](
  JSON.parse(
    '{"navId":"nav-110026","logoImageId":"logo-110023","containerId":"navBarId-110024"}'
  )
);
Core.utils.deferBootstrap(
  {
...
Core.utils.deferBootstrap(
  {
    ...
    props: JSON.parse(
      '{"toggleId":"n-110016110040-membershipId-loggedout","renderCustomIcon":{"name":"account","size":28,"minTarget":true},"overrideIconStyle":{},"dataAid":"MEMBERSHIP_ICON_DESKTOP_RENDERED","hasHover":true,"widgetId":"717b079b-c907-4135-a552-f66c429109fa","section":"default","category":"neutral","locale":"en-IN","env":"production","renderMode":"PUBLISH"}'
    ),
    context: JSON.parse(
      '{"widgetId":"717b079b-c907-4135-a552-f66c429109fa","widgetType":"HEADER","widgetPreset":"header9","group":"UtilitiesMenu","groupType":"Default","section":"default","category":"neutral","fontSize":"medium","fontFamily":"alternate","websiteThemeOverrides":{},"widgetThemeOverrides":{}}'
    ),
...
Core.utils.deferBootstrap(
  {
    ...
    componentName: "@widget/LAYOUT/bs-FlyoutMenu-Component",
    props: JSON.parse(
      '{"toggleId":"n-110016110040-membershipId","renderCustomIcon":{"name":"account","size":28,"minTarget":true},"overrideIconStyle":{},"dataAid":"MEMBERSHIP_ICON_DESKTOP_RENDERED","hasHover":true,"widgetId":"717b079b-c907-4135-a552-f66c429109fa","section":"default","category":"neutral","locale":"en-IN","env":"production","renderMode":"PUBLISH"}'
    ),
    context: JSON.parse(
      '{"widgetId":"717b079b-c907-4135-a552-f66c429109fa","widgetType":"HEADER","widgetPreset":"header9","group":"UtilitiesMenu","groupType":"Default","section":"default","category":"neutral","fontSize":"medium","fontFamily":"alternate","websiteThemeOverrides":{},"widgetThemeOverrides":{}}'
    ),
...
!(function () {
  window.initMembership("n-110016110040", false);
})();
...
window.wsb["StickyNav"](
  JSON.parse(
    '{"uniqueId":"header_stickynav110017","anchorId":"header_stickynav-anchor110018","logoHeight":75,"hasAnimation":true}'
  )
);
!(function () {
  window.initMembership("n-110016", true);
})();
window.wsb["BlogScrollDetector"] = function (e) {
  let { id: t } = e;
  if (!t || "undefined" == typeof window) return;
  const { hash: a, pathname: o, search: r } = window.location,
    s = r && new URLSearchParams(r);
  if (
    (o.includes("/f/") &&
      (window._BLOG_DATA && window._BLOG_DATA.post
        ? window._BLOG_DATA.post.slug
        : o.substr(o.indexOf("/f/") + "/f/".length))) ||
    (s && (s.get("blog") || s.get("blogcategory") || s.get("blogpost"))) ||
    (a && /^#post-\d+$/.test(a))
  ) {
...
window.wsb["BlogScrollDetector"](
  JSON.parse('{"id":"781805a6-be66-46a3-9cf8-3485e9188f03"}')
);
...
Core.utils.deferBootstrap(
  {
    elId: "bs-7",
    componentName: "@widget/RSS/bs-rss1-router",
    props: JSON.parse(
      '{"backgroundImage":"//img1.wsimg.com/isteam/stock/byy8zK0","upgradeable":false,"preset":"rss1","order":0,"id":"781805a6-be66-46a3-9cf8-3485e9188f03","viewDevice":null,"websiteId":"8e320b80-659d-4f80-b0ac-2aa5aa91f0c2","appDomain":"godaddy.com","isReseller":false,"staticContent":{"edit_mode_cta":{"title":"You don\'t have any blog posts yet","sub_title":"Let\'s create some content","btn_label":"Start Writing"},"readMore":"Continue Reading","staticFeed":[{"title":"Everything in its Place","content":"The French phrase \u201CMis En Place\u201D is taught to culinary students from the moment they enter school. Having \u201Ceverything in its place\u201D makes all the difference when the pressure is on and orders are piling up."},{"title":"Cold and Sweet Chocolate Treat","content":"Every now and then the craving hits for something cold, creamy, and loaded with chocolate goodness. Here is a quick and easy recipe to satisfy your chocolate needs!"},{"title":"Picnic Lunch","content":"Taking food on the go can be a challenge. The same old sandwiches can get boring. Here are some lunch ideas to keep your picnics exciting."},{"title":"The Perfect Poached Egg","content":"There\u2019s nothing more delicious in the morning than a perfectly poached egg. Honing your technique will make you the star of your friendly brunch gatherings."},{"title":"Picnic Lunch","content":"A box of random assorted vegetables is full of delicious possibilities. However, when your box arrives from your favorite farm, what do you do with all of this fresh produce?"}],"socialSharing":{"sharePost":"Share this post"},"rssToEmail":{"signUp":"Sign up","placeholder":"Email address","confirmation_1":"Thanks for signing up!","confirmation_2":"We\'ll send blog updates and other company news directly to your inbox.","confirmation_3":"Check your email to confirm your subscription.","cta":"Sign up for blog updates!","cta_subhed":"Join my email list to receive updates and information."},"noPosts":"Posts coming soon!","allPosts":"All Posts","showMore":"Show More","recentPosts":"Recent Posts","categories":"Categories","feedNotFetchable":"Sorry, we couldn\'t find your blog feed. Please check your URL and try again."},"pageId":"9a0c8f9f-6ce9-40ea-b65b-831d41e9bf0f","routePath":"/stempedia","siteFontScale":"medium","sectionTitle":"My Blog","blogType":"internal","rssFeed":"http://foodnetwork.tumblr.com/rss","categoriesFilter":[],"background":{"image":"//img1.wsimg.com/isteam/stock/byy8zK0"},"visitorMode":true,"currentPageRoute":"/stempedia","detachedMode":false,"widgetId":"781805a6-be66-46a3-9cf8-3485e9188f03","section":"default","category":"neutral","locale":"en-IN","env":"production","renderMode":"PUBLISH"}'
    ),
    context: JSON.parse(
      '{"widgetId":"781805a6-be66-46a3-9cf8-3485e9188f03","widgetType":"RSS","widgetPreset":"rss1","section":"default","category":"neutral","fontSize":"medium","fontFamily":"alternate","websiteThemeOverrides":{},"widgetThemeOverrides":{}}'
    ),
    contextKey: "context-bs-7",
    radpack: "@widget/RSS/bs-rss1-router",
  },
  false
);
Core.utils.deferBootstrap(
