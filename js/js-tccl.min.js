      ...
      [
        function (t, e, n) {
          ...
          var r,
            ...
            s =
              ...
              "undefined" == typeof window
                ? { window: i, document: o, navigator: a }
                : {
                    window: window || i,
          ...
          var f = function () {
            ...
            l = function () {
              var t = p(),
                e = t.split(".");
              2 <= e.length && (t = e.slice(e.length - 2).join("."));
              return t;
            };
          (function t(e, n, r) {
            var o = r || 1;
        ...
        function (t, e, n) {
          ...
          (e.isArray = o),
            (e.logToArray = function (t, e) {
              o(t) && t.push({ timestamp: (0, r.getISODate)(), data: e });
            }),
        ...
        function (t, e, n) {
          ...
          var p =
            ...
            c = [],
            h = function () {
              return (0, r.buildCorporateUrl)("events.api");
            },
            f = function (t, e, n, r) {
            ...
            y = function (t, e, n, r, o) {
              ...
              if ((0, s.getWindow)().XMLHttpRequest) {
                ...
                a.open(n, t, !0),
                  ...
                  (0, d.map)(i.headers, function (t, e) {
            ...
            v = function (t, e, n, r) {
              var o,
                ...
                u =
                  ...
                  a);
              if ("GET" === n) {
                var c = (0, l.encodeProperties)(u),
                  f = (0, l.assembleUrl)(c, s);
                y(f, (0, d.stringify)(c, "&", "="), n, null, r, {
                  withCredentials: !0,
                });
              } else y(s, null, n, u, r);
            };
          (e.init = function () {
            for (o = !0; 0 < c.length; ) {
              var t = c.shift();
              t[0].apply(undefined, t[1]);
            }
          }),
            (e.sendEvent = function (t, e, n, r) {
              o ? v(t, e, n, r) : c.push([v, [t, e, n, r]]);
            });
        },
        function (t, e, n) {
          "use strict";
          ...
          var r = n(0),
            ...
            i = (n(23), n(8)),
            a = function () {
              var t = (0, r.getWindow)().location.search;
              return "" === t
                ? []
                : ((0, i.startsWith)(t, "?") && (t = t.substring(1)),
                  t.split("&"));
            };
          (e.encodeProperties = function (t) {
            var n = {};
            return (
              (0, o.map)(t, function (t, e) {
                void 0 !== e && (n[t] = encodeURIComponent(e));
              }),
              n
            );
          }),
            (e.assembleUrl = function (t, e) {
              var n = ~e.indexOf("?") ? "&" : "?";
              return e + n + (0, o.stringify)(t, "&", "=");
            }),
            (e.getQueryStringParameter = function (t, e) {
              for (var n = a(), r = n.length - 1; 0 <= r; r--) {
                var o = n[r].split("=");
                if (e) {
                  if ((o[0] + "").toLowerCase() == (t + "").toLowerCase())
                    return o[1];
                } else if (o[0] === t) return o[1];
              }
            });
        },
        function (t, e, n) {
          "use strict";
          e.getCustomerId = e.getClaimFromInfoToken = undefined;
          n(9);
          var r = n(25),
            o = {},
            i = function (t) {
          ...
          (e.getClaimFromInfoToken = function (t) {
            if (a()) return u(o, t);
          }),
        ...
        function (t, e, n) {
          ...
          var r =
            ...
            (s.prototype.pushLog = function (t) {
              (0, a.logToArray)(this.dataLayerLog, t);
            }),
          ...
          function s(t) {
            ...
            !(function t(e, n) {
              ...
              (this.loaded = !1),
              (this.dataLayers = []),
              (0, a.isArray)(this.dataLayerName) ||
                (this.dataLayerName = [this.dataLayerName]),
              this.dataLayerName.forEach(function (t) {
                var e,
                  n = (0, o.getWindow)()[t];
                n && (e = r.asyncCommands).push.apply(e, n);
                (0, i.setWindowVar)(t, r), r.dataLayers.push(n);
              });
          }
          e.default = r;
        },
        function (t, e, n) {
          ...
          var c = "OPTIONAL",
            ...
            p = function (t, e, n, r) {
              ...
              var i = o;
              if (((0, h.isArray)(i) || n) && !(i = s(i, n))) return undefined;
              var a = i[r];
              return a || undefined;
            },
            l = function (t, e) {
            ...
            g = function (t, e, n, r) {
              var o = void 0;
              if (e.validationType !== y) {
                var i = t[e.name];
                e.resolutionType === v && (i = t), (o = e.parse(i, n));
              }
              if ("object" !== d(e.transformMap))
                return "function" == typeof e.transformMap
                  ? e.transformMap(o, r)
                  : e.transformMap;
              for (
                var a,
            ...
            m =
              ((b.prototype.parse = function (t, e) {
                if ((this.validate(t), this.validationType !== c || t)) {
                  for (
                    var n = new u.default(), r = 0;
                    r < this.properties.length;
                    r++
                  ) {
                    var o = this.properties[r];
                    if (!(0 < o.sinkList.length) || ~o.sinkList.indexOf(e)) {
                      var i = g(t, o, e, n.getProperties());
                      o.resolutionType === f ? n.set(l(o, e), i) : n.merge(i);
                    }
                  }
                  for (var a = 0; a < this.properties.length; a++) {
                    var s = this.properties[a].doNotOutputList;
                    (s.includes(e) || s.includes("ALL")) &&
                      n.delete(l(this.properties[a], e));
                  }
                  return n.getProperties();
                }
              }),
              (b.prototype.validate = function (t) {
                if (this.validationType === o && !t)
                  throw "Missing required property '" + this.name + "'";
              }),
              (b.prototype.optional = function () {
                return (this.validationType = c), this;
              }),
              ...
              (b.prototype.doNotOutput = function (t) {
                return (
                  void 0 === t
                    ...
                    : (0, h.isArray)(t) && (this.doNotOutputList = t),
                  this
                );
              }),
              b);
                ...
                if (this.schema.data && 0 < this.schema.data.length)
                  try {
                    ...
                    for (var o = 0; o < n.length; o++) {
                      var i = n[o];
                      this.load(i),
                        (r[i] = _.prototype.parse.call(this, t || {}, i)),
                        this.clean();
                    }
                  } catch (t) {
                    throw "";
            ...
            C =
              ...
              (P.prototype.load = function (t) {
                (this.properties = this.properties.concat(this.objDefinitions)),
                  ...
                  T.prototype.load.call(this, t);
              }),
              (P.prototype.stringify = function () {
                if (this.resolutionType !== f)
                  return T.prototype.stringify.call(this);
                var t = {};
                return (
                  (t[this.name + " (" + this.validationType + ")"] =
                    T.prototype.stringify.call(this)),
                  t
                );
              }),
              (P.prototype.substitute = function (t) {
                return (
                  (this.objDefinitions = t), (this.resolutionType = v), this
                );
              }),
          ...
          function P() {
            a(this, P);
            var t = i(this, T.call(this));
            return (
              (t.objDefinitions = []),
              (t.definitionType = "Object"),
              (t.validationType = c),
              t
            );
          }
          ...
          r(D, (j = C)),
            ...
            (D.prototype.stringify = function () {
              if (this.resolutionType !== f)
                return j.prototype.stringify.call(this);
              var t = {};
              t[this.minElements + "...n"] =
                j.prototype.stringify.call(this)[
                  this.name + " (" + this.validationType + ")"
                ];
              var e = {};
              return (e[this.name + " (" + this.validationType + ")"] = t), e;
            }),
            (D.prototype.withMinElements = function (t) {
              return (
                (this.minElements = t),
                (this.validationType = 0 < t ? o : c),
                this
              );
            });
          function D() {
          ...
          function A(t) {
            a(this, A);
            var e = i(this, M.call(this, t));
            return (e.validationType = y), e;
          }
          (e.SchemaDefinitionBlock = w),
            (e.PropertyDefinitionBlock = L),
            (e.ObjectDefinitionBlock = C);
        },
        function (t, e, n) {
          "use strict";
          e.__esModule = !0;
          ...
          (0, d.withCookieCache)(function () {
            if ((0, o.isSupported)())
              if (
                ...
                (0, a.init)("_trfd", [w]),
                (0, f.init)(
                  (e = l.default.get(w + ".baseHost"))
                    ? "secureserver.net" === e
                      ? "prod"
                      : "test-secureserver.net" === e
                      ? "test"
                      : "dev"
                    : l.default.get(w + ".buildEnv")
                ),
                (0, r.libraryLoaded)())
              )
        ...
        function (t, e, n) {
          ...
          var i = void 0,
            a = function () {
              if (i) return i;
              var t = (0, r.getBaseHost)();
              if (
                "secureserver.net" ===
                (t = (0, r.isCorporateHost)(t) ? t : "secureserver.net")
              ) {
                var e = (0, o.getEnvName)();
                t = "prod" === e ? t : e + "-" + t;
              }
              return (i = t);
            };
          e.buildCorporateUrl = function () {
            var t =
              0 < arguments.length && arguments[0] !== undefined
                ? arguments[0]
                : "";
            return "https://" + (t ? t + "." : "") + a();
          };
                      ...
                      S < 16
                        ...
                        : O(
                            O(
                              O(
                                ((c = l[S - 2]),
                                T(c, 17) ^ T(c, 19) ^ C(c, 10)),
                                l[S - 7]
                              ),
                              ((u = l[S - 15]), T(u, 7) ^ T(u, 18) ^ C(u, 3))
                            ),
                            l[S - 16]
                          )),
                      (E = O(
        ...
        function (t, e, n) {
          ...
          var f,
            o = ["_expDataLayer", "_signalsDataLayer"],
            i =
              ((function t(e, n) {
                if ("function" != typeof n && null !== n)
                  throw new TypeError(
              ...
              (a.prototype._initPageView = function () {
              ...
              (a.prototype.loadAsyncCommands = function () {
        ...
        function (t, e, n) {
          "use strict";
          e.observePerfMetrics = e.getPerformanceData = undefined;
          var r = n(1),
            o = n(8),
            i = n(0),
            a = n(2),
                  ...
                  (0, i.getWindow)()._expDataLayer.push({
                    ...
                    data:
                      "tcc" === t
                        ...
                        : {
                            timing_object: (0, a.merge)(e, {
                              largestContentfulPaint: c.lcp,
                            }),
          ...
          (e.getPerformanceData = function (t, e, n) {
            ...
            (e.observePerfMetrics = function () {
              var t = (0, i.getWindow)();
              if (t.PerformanceObserver) {
                var e = new t.PerformanceObserver(function (t) {
                  var e = t.getEntries(),
                    n = e[e.length - 1];
                  n.renderTime && (c.lcp = Math.round(n.startTime));
                });
                try {
